...
<p align="center"><sub>A deliberately simplified public domain map. Internal service topology is not shown.</sub></p>
...
# These private/internal research links and redundant implementation captions must stay absent.
for forbidden in [
